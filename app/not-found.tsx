      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 space-y-6">
          <div className="rounded-md shadow-sm space-y-4">
            ...
            >
              Go to Zensu&apos;s home page
            </Link>
            <Link
              href="/help"
              className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-semibold rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
              Help
            </Link>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link
              href="/help"
              className="font-medium text-shop_dark_green hover:text-shop_dark_green/80"
            >
              Help section
            </Link>{" "}
            or{" "}
