  ...
  return (
    <Container>
      {favoriteProduct?.length > 0 ? (
        <>
          <div className="overflow-x-auto p-5 md:p-16">
                      ...
                      <td className="px-2 py-2 flex items-center gap-2">
                        ...
                        {product?.images && (
                          <Link
                            ...
                            className="border group hidden md:inline-flex"
                          >
                            <Image
                              ...
                              width={80}
                              height={80}
                              className="group-hover:scale-105 hoverEffect h-20 w-20 object-contain"
                            />
                          </Link>
                        )}
